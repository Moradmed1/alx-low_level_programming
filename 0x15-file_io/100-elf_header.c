...
void ck_elf(unsigned char *e_id);
void pt_magic(unsigned char *e_id);
void pt_class(unsigned char *e_id);
void pt_data(unsigned char *e_id);
void pt_version(unsigned char *e_id);
void pt_abi(unsigned char *e_id);
void pt_osabi(unsigned char *e_id);
void pt_type(unsigned int e_type, unsigned char *e_id);
...
ck_elf(header->e_id);
printf("ELF Header:\n");
pt_magic(header->e_id);
pt_class(header->e_id);
pt_data(header->e_id);
pt_version(header->e_id);
pt_osabi(header->e_id);
pt_abi(header->e_id);
pt_type(header->e_type, header->e_id);
